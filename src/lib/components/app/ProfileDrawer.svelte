...
{#if showProfileDrawer}
  <div class="fixed inset-0 z-[100]" role="dialog" aria-modal="true">
    ...
    <button
      type="button"
      class="absolute inset-0 bg-dark/45 backdrop-blur-sm border-none cursor-default"
      onclick={close}
    ...
    >
      <div class="flex flex-col h-full">
        ...
        <div class="p-6 border-b border-gray-200">
          ...
          <button onclick={() => navigate('/settings')} class="text-sm text-primary font-medium hover:underline">
            View Settings →
          </button>
        </div>
        ...
        <nav class="flex-1 overflow-y-auto p-4 space-y-6">
          ...
          <div>
            ...
            <div class="space-y-1">
              <button onclick={() => navigate('/')} class="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-gray-50 transition-colors text-left">
          ...
          <div>
            ...
            <div class="space-y-1">
              <button onclick={() => navigate('/blog')} class="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-gray-50 transition-colors text-left">
                <svg class="w-5 h-5 text-text-muted" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <button onclick={() => navigate('/vendor')} class="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-gray-50 transition-colors text-left">
                <svg class="w-5 h-5 text-text-muted" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h18v18H3V3z"/>
                </svg>
                <span class="text-body text-text-main">Vendor</span>
              </button>
              <button onclick={() => navigate('/shop')} class="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-gray-50 transition-colors text-left">
                <svg class="w-5 h-5 text-text-muted" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <div class="space-y-1">
              <button onclick={() => navigate('/orders')} class="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-gray-50 transition-colors text-left">
                <svg class="w-5 h-5 text-text-muted" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"/>
                </svg>
                <span class="text-body text-text-main">Orders</span>
              </button>
              <button onclick={() => navigate('/wishlist')} class="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-gray-50 transition-colors text-left">
                <svg class="w-5 h-5 text-text-muted" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"/>
                </svg>
                <span class="text-body text-text-main">Wishlist</span>
              </button>
              <button onclick={() => navigate('/following')} class="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-gray-50 transition-colors text-left">
                <svg class="w-5 h-5 text-text-muted" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <div class="space-y-1">
              <button onclick={() => navigate('/notifications')} class="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-gray-50 transition-colors text-left">
                <svg class="w-5 h-5 text-text-muted" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"/>
                </svg>
                <span class="text-body text-text-main">Notifications</span>
              </button>
              <button onclick={() => navigate('/settings')} class="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-gray-50 transition-colors text-left">
                <svg class="w-5 h-5 text-text-muted" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <button onclick={() => navigate('/support')} class="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-gray-50 transition-colors text-left">
                <svg class="w-5 h-5 text-text-muted" fill="none" stroke="currentColor" viewBox="0 0 24 24">
