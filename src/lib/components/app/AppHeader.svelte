...
<header class="sticky top-0 z-50 bg-surface border-b border-gray-200 h-20 shadow-sm">
  <div class="max-w-7xl mx-auto px-4 h-full flex items-center justify-between gap-4">
    ...
    <a href="/home" class="flex items-center gap-2 flex-shrink-0">
      <div class="w-9 h-9 bg-primary rounded-xl flex items-center justify-center text-white font-bold text-lg">
        V
      </div>
      <span class="hidden md:block text-xl font-bold text-text-main">VendorHub</span>
    </a>
    ...
    <div class="flex items-center gap-2">
      ...
      <button class="md:hidden p-2 text-text-muted hover:text-primary transition-colors" aria-label="Search">
