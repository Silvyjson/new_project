...
<div class="relative">
  ...
  {#if showDropdown && searchQuery.length > 0}
    <div
      class="absolute top-full left-0 right-0 mt-2 bg-surface rounded-xl shadow-card border border-gray-200 overflow-hidden z-50"
    >
      ...
      <div class="max-h-[300px] overflow-y-auto">
        ...
        <div class="p-2 border-t border-gray-100">
          ...
          {#each [1, 2] as i}
            ...
            >
              <div
                class="w-10 h-10 bg-primary/10 rounded-full flex items-center justify-center text-primary font-semibold"
              >
