      ...
      <div class="grid md:grid-cols-4 gap-8 mb-12">
        ...
        <div>
          ...
          <ul class="space-y-2 text-small text-gray-400">
            ...
            <li>
              <a href="/trust" class="hover:text-white transition-colors"
                >Trust & Safety</a
              >
            </li>
          </ul>
        ...
        <div>
          ...
          <ul class="space-y-2 text-small text-gray-400">
            ...
            <li>
              <a href="/press" class="hover:text-white transition-colors"
                >Press</a
              >
            </li>
          </ul>
        ...
        <div>
          ...
          <ul class="space-y-2 text-small text-gray-400">
            ...
            <li>
              <a href="/payments" class="hover:text-white transition-colors"
                >Payment Policy</a
              >
            </li>
            <li>
