...
const mockProduct = {
  ...
  description:
    "The Air Jordan 1 Retro High brings back the classic basketball silhouette with premium leather upper, Nike Air cushioning, and the iconic Wings logo. This timeless design continues to set the standard for sneaker culture.",
  longDescription: `
  ...
  reviews: [
    {
      ...
      date: "2024-05-20",
      content:
        "Absolutely love these shoes! The quality is top-notch and they are very comfortable. Delivery was also very fast.",
      verifiedMatch: true,
    },
    {
      userName: "Bukola A.",
      ...
      date: "2024-05-15",
      content:
        "Great product, looks exactly like the pictures. Subtracted one star because the box was slightly dented during shipping.",
      verifiedMatch: true,
