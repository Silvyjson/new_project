...
const mockReviews = [
  {
    ...
    rating: 5,
    content:
      "Amazing quality! The sneakers arrived exactly as pictured. Delivery was fast and the packaging was secure. Will definitely order again.",
  ...
  },
  {
    ...
    rating: 5,
    content:
      "Best sneaker shop on VendorHub! Authentic products and great customer service. Highly recommend.",
  ...
  },
  {
    ...
    rating: 4,
    content:
      "Good quality but delivery took a bit longer than expected. Overall satisfied with my purchase.",
