...
<script lang="ts">
  ...
  const wishlistShops = [
    { id: 1, name: 'TechStoreNG', logo: '🏪', banner: 'bg-blue-100', products: 120, trustScore: 94 },
    { id: 2, name: 'Amina Fashion', logo: '👗', banner: 'bg-pink-100', products: 85, trustScore: 92 },
    { id: 3, name: 'Home Essentials', logo: '🏠', banner: 'bg-green-100', products: 200, trustScore: 89 }
  ];
