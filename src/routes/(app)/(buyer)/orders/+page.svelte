  ...
  let orders = [
    {
      ...
      vendor: 'TechStoreNG',
      items: [
        { name: 'Wireless Earbuds', image: 'https://images.unsplash.com/photo-1590658268037-6bf12165a8df', quantity: 1 }
      ],
      total: 25000
    },
    {
      ...
      items: [
        { name: 'Cotton Dress', image: 'https://images.unsplash.com/photo-1515886657613-9f3515b0c78f', quantity: 1 }
      ],
      total: 12000
    },
    {
      ...
      items: [
        { name: 'Kitchen Set', image: 'https://images.unsplash.com/photo-1556911220-bff31c812dba', quantity: 1 }
      ],
      total: 18000
    }
  ];
...
<div class="max-w-[1000px] mx-auto px-4 py-8">
  ...
  {#if filteredOrders.length === 0}
    <Card className="py-16 text-center">
      ...
      <p class="text-body text-text-muted">Try selecting a different tab or start shopping.</p>
    </Card>
  {:else}
    <div class="space-y-4">
        ...
        <Card className="border border-gray-200 p-6">
          <div class="flex items-start justify-between mb-4">
            <div>
              ...
              <p class="text-sm text-text-muted">{formatDate(order.date)} • {order.vendor}</p>
            </div>
