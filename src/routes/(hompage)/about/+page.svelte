...
<main class="min-h-screen bg-surface">
    ...
    >
        ...
        >
            ...
            >
                <a
                    href="#how-it-works"
                    class="hover:text-primary transition-colors">How It Works</a
                >
                <a
                    href="#what-we-do"
                    class="hover:text-primary transition-colors">What We Do</a
                >
                ...
                <a
                    href="/vendors/shops"
                    class="hover:text-primary transition-colors">Shops</a
                >
            </div>
        ...
        {#if mobileMenuOpen}
            ...
            >
                <a href="#how-it-works" class="text-text-main font-medium"
                    >How It Works</a
                >
                <a href="#what-we-do" class="text-text-main font-medium"
                    >What We Do</a
                >
    ...
    <!-- 🔷 SECTION 1: HERO (Mission-Focused) -->
    <section
